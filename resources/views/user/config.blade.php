...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            @endif
            <div class="card">
                <div class="card-header">Configurar Perfil</div>
                ...
                <form method="POST" action="{{ route('user.update') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="rol" type="text" class="form-control @error('role') is-invalid @enderror" name="role" value="{{ Auth::user()->role }}" required autocomplete="role" readonly>
